...
Mac/Sat/ZDPA set send_timeout_ 3000ms; # resend if send times out
...
Mac/Sat/ZDPA set windowt 15000 ;
...
proc finish {} {
	set f [open zdpa-records/record9.txt a]
