...
#test 1 num nodes = 150

fil="zdpa-records/record3.txt"
filawk="zdpa-sh/throughput.awk"
filtcll="zdpa-sh/test3/zdpa-tcl-group.tcl"
echo "test 3, pkt lenght = 168 bits num_nodes = 100 poisson rate = 10Mb" > $fil 
