...
fil="zdpa-records/record8.txt"
filawk="zdpa-sh/throughput.awk"
filtcll="zdpa-sh/test8/zdpa-tcl-group.tcl"
echo "test 8, pkt lenght = 168 bits num_nodes = 200 poisson rate = 10Mb poisson idle time = 2s" >> $fil 
