...
fil="zdpa-records/record7.txt"
filawk="zdpa-sh/throughput.awk"
filtcll="zdpa-sh/test7/zdpa-tcl-group.tcl"
echo "test 7, pkt lenght = 168 bits num_nodes = 300 poisson rate = 10Mb poisson idle time = 4s" >> $fil 
