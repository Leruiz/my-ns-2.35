puts "6 argues : Poisson k, r, p, num_nodes, idle_time"
if { $argc != 6 } {
        puts stderr {usage: ns sat-aloha.tcl [Poisson k p r num_nodes, idle_time]}
        exit 1
}
...
set n_node_ [lindex $argv 4]
set t_idle_ [lindex $argv 5]
...
proc finish {} {
	set f [open zdpa-records/record10.txt a]
