...
fil="zdpa-records/record6.txt"
filawk="zdpa-sh/throughput.awk"
filtcll="zdpa-sh/test6/zdpa-tcl-group.tcl"
echo "test 6, pkt lenght = 168 bits num_nodes = 250 poisson rate = 10Mb poisson idle time = 4s" >> $fil 
