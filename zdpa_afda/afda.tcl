...
Mac/Sat/AFDA set mean_backoff_ 0.01s ; # mean exponential backoff time(s)
Mac/Sat/AFDA set rtx_limit_ 40; # max number of retrans. attempted 
Mac/Sat/AFDA set send_timeout_ 4000ms; # resend if send times out

#Mac/Sat/AFDA set half_retrans_max 3;
Mac/Sat/AFDA set bit_duration 0.1ms;
Mac/Sat/AFDA set windowt 20000 ;
Mac/Sat/AFDA set deltat 10000 ;
Mac/Sat/AFDA set decode_iter_max 5000;
Mac/Sat/AFDA set buffer_max 5000;
...
proc finish {} {
	set f [open zdpa_afda/afda_record.txt a]
...
puts $f "AFDA RetranstimesSum $retranstime" 
