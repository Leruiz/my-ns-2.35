...
proc finish {} {
	set f [open zdpa-soliton-20/soliton-test-length/record.txt a]
set solitonavelenotl [new SolitonAveLen]
set solitonavelen [$solitonavelenotl returnSolitonAveLen]
puts $f "SOlitonAveLen $solitonavelen"
close $f
	global ns outfile 
	$ns flush-trace
	close $outfile
