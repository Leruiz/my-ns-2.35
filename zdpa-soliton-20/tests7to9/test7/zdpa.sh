...
fil="zdpa-soliton-20/tests7to9/zdpa-records/record7.txt"
filawk="zdpa-soliton-20/tests7to9/throughput.awk"
filtcll="zdpa-soliton-20/tests7to9/test7/zdpa-tcl-group.tcl"

echo "test7 Soliton k = 4, r = 0.5, p = 0.75" >> $fil
