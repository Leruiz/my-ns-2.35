...
fil="zdpa-soliton-20/tests7to9/zdpa-records/record8.txt"
filawk="zdpa-soliton-20/tests7to9/throughput.awk"
filtcll="zdpa-soliton-20/tests7to9/test8/zdpa-tcl-group.tcl"

echo "test8 Soliton k = 6, r = 0.5, p = 0.75" >> $fil
