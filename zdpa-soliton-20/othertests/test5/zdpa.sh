...
fil="zdpa-soliton-20/othertests/zdpa-records/record5.txt"
filawk="zdpa-soliton-20/othertests/throughput.awk"
filtcll="zdpa-soliton-20/othertests/test5/zdpa-tcl-group.tcl"

echo "test5 Soliton k = 6, r = 0.5, p = 0.25" >> $fil
